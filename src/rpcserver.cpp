...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop haroldcoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "haroldcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pivx features */
        {"haroldcoin", "masternode", &masternode, true, true, false},
        {"haroldcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"haroldcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"haroldcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"haroldcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"haroldcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"haroldcoin", "startmasternode", &startmasternode, true, true, false},
        {"haroldcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"haroldcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"haroldcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"haroldcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"haroldcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"haroldcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"haroldcoin", "mnbudget", &mnbudget, true, true, false},
        {"haroldcoin", "preparebudget", &preparebudget, true, true, false},
        {"haroldcoin", "submitbudget", &submitbudget, true, true, false},
        {"haroldcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"haroldcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"haroldcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"haroldcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"haroldcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"haroldcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"haroldcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"haroldcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"haroldcoin", "mnsync", &mnsync, true, true, false},
        {"haroldcoin", "spork", &spork, true, true, false},
        {"haroldcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"haroldcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use haroldcoind, or the -server option to haroldcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               "It is recommended you use the following random password:\n"
                                               "rpcuser=haroldcoinrpc\n"
                                               "rpcpassword=%s\n"
                                               "(you do not need to remember this password)\n"
                                               "The username and password MUST NOT be the same.\n"
                                               "If the file does not exist, create it with owner-readable-only file permissions.\n"
                                               "It is also recommended to set alertnotify so you are notified of problems;\n"
                                               "for example: alertnotify=echo %%s | mail -s \"haroldcoin Alert\" admin@foo.com\n"),
...
{
    return "> haroldcoin-cli " + methodname + " " + args + "\n";
}
