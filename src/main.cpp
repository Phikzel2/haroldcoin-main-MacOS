...
#if defined(NDEBUG)
#error "haroldcoin cannot be compiled without assertions."
#endif
...
{
    CAmount nSubsidy = 0;
    CAmount nSlowSubsidy = 200 * COIN;

    if (nHeight == 0) {
        nSubsidy = 10000000 * COIN;
   	 } 
        else if (nHeight >= 1 && nHeight <= 1000000 ) {
        nSubsidy = 200 * COIN;   
...
{
    RenameThread("haroldcoin-scriptch");
...
int ActiveProtocol()
{
    ...
    // SPORKboost::placeholders::_14 was used for 70710. Leave it 'ON' so they don't see < 70710 nodes. They won't react to SPORKboost::placeholders::_15
...
*/
    ...
    // SPORKboost::placeholders::_15 is used for 70910. Nodes < 70910 don't see it and still get their protocol version via SPORKboost::placeholders::_14 and their 
