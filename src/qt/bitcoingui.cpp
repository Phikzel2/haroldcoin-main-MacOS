                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("haroldcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a haroldcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and haroldcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About haroldcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about haroldcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for haroldcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your haroldcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified haroldcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a haroldcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the haroldcoin Core help message to get a list with possible haroldcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("haroldcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to haroldcoin network", "", count));
}
...
{
    QString strTitle = tr("haroldcoin Core"); // default title
